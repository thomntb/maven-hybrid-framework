...
public class My_Account extends BaseTest {
	...
	private String emailUser, firstName, lastName, passwordUser, emailUpdate, newPassword;
	...
	public void My_Account_TC_03() {
		...
		userChangePasswordPage.sendkeyToChangePasswordTextbox("Old password", passwordUser);
		...
		userLoginPage.loginAsUser(emailUpdate, passwordUser);
