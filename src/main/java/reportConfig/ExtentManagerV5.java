...
//		ExtentSparkReporter reporter = new ExtentSparkReporter(GlobalConstants.PROJECT_PATH + "/extendReportV5/ExtentReport.html");
...
//		extentReports.setSystemInfo("User", "ThomNTB");
